...
insertPrescriptionData = () => {
    db.run('INSERT INTO prescriptions(name, filename, frequency, date_of_prescription, description, doctor_name) VALUES(?, ?, ?, ?, ?, ?)',
        ["perindopril", "uploads/cfarmafoto323175_1100.jpg", "Once a day", "27st April 2021", "Perindopril is a medication used to treat high blood pressure, heart failure, or stable coronary artery disease.", "Dr. Strange"])
    
    db.run('INSERT INTO prescriptions(name, filename, frequency, date_of_prescription, description, doctor_name) VALUES(?, ?, ?, ?, ?, ?)',
        ["panadol", "uploads/adheretech_bottle_640.jfif", "Maximum 4 a day", "21 st July 2021",
